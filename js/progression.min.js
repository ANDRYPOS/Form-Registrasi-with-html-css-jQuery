(function(e,t,n,r){
    function o(t,n){
        this.element=t;this.$elem=e(this.element);
        this.options=e.extend({},s,n);
        this._defaults=s;
        this._name=i;
        this.init()}var i="progression",s={
            tooltipWidth:"200",
        ...
        o.prototype={
            init:function(){
                ...
                if(data_prog.first().attr("data-helper")!==r){firsthelper=data_prog.first().attr("data-helper")
            }else{
                firsthelper=""
                ...
                $display2=""
            }var n=this.options.tooltipAnimate?"-webkit-transition: top .3s ease-in-out;
            -moz-transition: top .3s ease-in-out;
            -o-transition: top .3s ease-in-out;
            transition: top .3s ease-in-out;
            ":"";var i=this.options.tooltipAnimate?"-webkit-transition: width .3s ease-in-out;
            -moz-transition: width .3s ease-in-out;-o-transition: width .3s ease-in-out;
            transition: width .3s ease-in-out;":"";
            var s=this.options.tooltipPosition=="right"?"border-color: transparent #"+this.options.tooltipBackgroundColor+" transparent transparent;
            ":"border-color: transparent transparent transparent #"+this.options.tooltipBackgroundColor+"";
